# Generated by Django 4.2.7 on 2023-11-16 02:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('update_at', models.DateTimeField(auto_now=True)),
                ('invssus_codigo_inventario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appmanager.inventario')),
            ],
        ),
        migrations.CreateModel(
            name='Menu',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('update_at', models.DateTimeField(auto_now=True)),
                ('sucursal_cod_gerente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appmanager.personaxcargo')),
            ],
        ),
        migrations.CreateModel(
            name='VehiculoVenta',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('update_at', models.DateTimeField(auto_now=True)),
                ('vehrep_dueño', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appmanager.personaxcargo')),
            ],
        ),
        migrations.CreateModel(
            name='RepuestoVenta',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='appmanager.rol'),
        ),
        migrations.AddField(
            model_name='personaxcargo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('update_at', models.DateTimeField(auto_now=True)),
                ('permiso_cod_menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appmanager.menu')),
                ('permiso_cod_rol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appmanager.rol')),
            ],
        ),
        migrations.CreateModel(
            name='OrdenTrabajo',
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('update_at', models.DateTimeField(auto_now=True)),
                ('orden_encargado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appmanager.personaxcargo')),
        ...
        migrations.AddField(
            model_name='usuario',
            name='cod_rol',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appmanager.rol'),
        ),
        migrations.AddField(
            model_name='usuario',
            name='groups',
